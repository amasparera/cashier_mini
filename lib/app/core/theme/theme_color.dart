...
enum AppColor {
  ...
  Color color(BuildContext context) {
    ...
    return switch (this) {
      ...
      AppColor.surfaceVariant => theme.colorScheme.surfaceVariant,
      ...
      AppColor.background => theme.colorScheme.background,
      AppColor.onBackground => theme.colorScheme.onBackground,
